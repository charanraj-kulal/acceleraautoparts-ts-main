    ...
    <div className="bg-gray-50 dark:bg-gray-900 font-[Montserrat] min-h-screen">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="text-center lg:text-left">
              <div className="inline-flex items-center bg-orange-500/10 border border-orange-500/20 px-4 py-2 rounded-full text-orange-400 text-sm font-medium mb-6">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <div
                key={index}
                className="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl p-8 text-center transform hover:scale-105 transition-all duration-500 hover:shadow-3xl"
              >
                <div
                  className={`w-20 h-20 bg-gradient-to-r ${stat.color} rounded-full flex items-center justify-center mx-auto mb-6 text-white shadow-lg`}
                >
                  {stat.icon}
                </div>
      ...
      <div className="max-w-7xl pt-20 font-[Montserrat] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="min-h-[500px]">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div className="relative">
                <div className="absolute -top-6 -left-6 w-full h-full bg-gradient-to-br from-orange-200 to-orange-300 dark:from-orange-900/30 dark:to-orange-800/30 rounded-3xl"></div>
                <div className="relative bg-gray-200 dark:bg-gray-700 rounded-3xl h-96 overflow-hidden">
                  <img
              ...
              <div>
                ...
                <div className="bg-gradient-to-r from-orange-50 to-orange-100 dark:from-orange-900/20 dark:to-orange-800/20 border-l-4 border-orange-500 p-8 rounded-2xl">
                  <Quote className="w-8 h-8 text-orange-500 mb-4" />
                  <p className="text-orange-800 dark:text-orange-300 italic text-xl mb-4 leading-relaxed">
                    "Our success comes from treating every customer like they're
                    our only customer. We don't just sell parts – we build
                    relationships that last."
                  </p>
                  <p className="text-orange-900 dark:text-orange-200 font-bold">
            ...
            <div className="grid grid-cols-1 py-20 lg:grid-cols-2 gap-12">
              <div className="bg-white dark:bg-gray-800 rounded-3xl p-10 shadow-2xl">
                <div className="flex items-center mb-8">
                  <div className="w-16 h-16 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full flex items-center justify-center mr-6">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-3xl p-10 shadow-2xl">
                <div className="flex items-center mb-8">
                  <div className="w-16 h-16 bg-gradient-to-r from-purple-500 to-purple-600 rounded-full flex items-center justify-center mr-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            {values.map((value, index) => (
              <div key={index} className="group">
                <div
                  className={`${value.color} rounded-3xl p-10 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2`}
                >
                  <div className="flex items-center mb-8">
                    <div
                      className={`w-20 h-20 bg-gradient-to-r ${value.gradient} rounded-full flex items-center justify-center mr-6 text-white shadow-lg group-hover:scale-110 transition-transform duration-300`}
                    >
                      {value.icon}
                    </div>
                    <h3 className="text-3xl font-bold text-gray-900 dark:text-white">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {value.features.map((feature, idx) => (
                      <div
                        key={idx}
                        className="bg-white dark:bg-gray-800 px-4 py-3 rounded-xl text-sm font-medium text-gray-700 dark:text-gray-300 shadow-sm flex items-center"
                      >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {qualitySteps.map((step, index) => (
              <div key={index} className="relative">
                <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-xl text-center relative z-10">
                  <div className="w-16 h-16 bg-gradient-to-r from-orange-500 to-orange-600 rounded-full flex items-center justify-center mx-auto mb-6 text-white">
                    {step.icon}
                  </div>
              ...
              >
                <div className="md:flex">
                  <div className="md:w-1/3">
                    <div className="h-64 md:h-full bg-gradient-to-br from-gray-200 to-gray-300 dark:from-gray-700 dark:to-gray-600 flex items-center justify-center">
                  ...
                  <div className="md:w-2/3 p-8">
                    ...
                    <div className="bg-gradient-to-r from-orange-50 to-orange-100 dark:from-orange-900/20 dark:to-orange-800/20 p-4 rounded-xl mb-6">
                      <Quote className="w-5 h-5 text-orange-500 mb-2" />
                      <p className="text-orange-800 dark:text-orange-300 italic">
                        {member.quote}
                      </p>
                    </div>
        ...
        {/* <div className="mb-32">
          <div className="text-center mb-16">
            <h2 className="text-5xl font-bold text-gray-900 dark:text-white mb-6">
              <span className="text-orange-500">Certifications</span> & Awards
            </h2>
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {certifications.map((cert, index) => (
              <div
                key={index}
                className="bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-xl text-center hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2"
              >
                <div
                  className={`w-16 h-16 ${cert.color} rounded-full flex items-center justify-center mx-auto mb-6 text-white`}
                >
                  {cert.icon}
                </div>
        ...
        <div className="mb-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <div
                key={index}
                className="bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2"
              >
        ...
        <div className="mb-32">
          <div className="bg-gradient-to-r from-orange-50 to-orange-100 dark:from-orange-900/20 dark:to-orange-800/20 rounded-3xl p-16 relative overflow-hidden">
        ...
        <div className="mb-16">
          <div className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 rounded-3xl p-16 text-center relative overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-full h-full">
              ...
              <div className="absolute top-1/2 left-1/2 w-40 h-40 bg-purple-500/20 rounded-full blur-xl animate-pulse delay-2000"></div>
            </div>
