...
const UsedSteeringColumn = () => {
  ...
  const benefits = [
    {
      ...
      description:
        "Used steering columns cost 70% less than new ones with same functionality",
    },
    {
      icon: <Settings className="h-6 w-6" />,
      title: "Perfect Control",
      description: "Restore precise steering control and driving comfort",
    },
    {
  ...
  const features = [
    {
      ...
      description:
        "Premium OEM used steering columns with guaranteed performance",
    },
    {
    ...
    },
    {
      ...
      description:
        "Thorough inspection for optimal steering response and control",
    },
    {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left">
              ...
              <p className="text-xl text-orange-100 mb-8 max-w-2xl">
                Restore your vehicle's steering precision with our premium
                quality used steering columns. Tested for functionality, safety,
                and reliability.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">
              Why Choose Used Steering Columns?
            </h2>
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Experience the perfect balance of control, safety, and value with
              our premium used steering columns
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-900/20 dark:to-orange-800/20 rounded-2xl p-0 h-96 flex items-center justify-center overflow-hidden">
                <img
                  src="/assets/images/car_parts/steering_column.png"
                  alt="Used Steering Columns"
            ...
            <div className="space-y-6">
              <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
                Steering columns are critical components that connect your
                steering wheel to the steering mechanism, providing precise
                control and incorporating essential safety features. Our premium
                used steering columns deliver exceptional performance while
                offering significant cost savings compared to new replacements.
              </p>

              <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
                At Accelera Auto Parts, we carefully inspect every used steering
                column for structural integrity, functionality, and safety
                compliance. Each column undergoes rigorous testing to ensure it
      ...
      <section className="py-20 bg-gray-50 dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Experience excellence with our premium steering column services
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-lg">
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">
                Our Steering Column Promise
              </h3>
              <p className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                With extensive experience in automotive steering systems, we at
                Accelera Auto Parts specialize in sourcing and testing premium
                used steering columns. We guarantee functionality and safety
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-700 dark:text-gray-300">
                    Premium A-Grade OEM Used Steering Columns
                  </span>
                </div>
                <div className="flex items-center space-x-3">
                  <CheckCircle className="h-5 w-5 text-green-500" />
            ...
            <div className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl p-8 text-white">
              <h3 className="text-2xl font-bold mb-6">Steering Expertise</h3>
              <p className="text-orange-100 mb-6 leading-relaxed">
                Our team of steering specialists brings years of experience in
                steering column evaluation, testing, and customer service. We're
                here to help you find the perfect steering column for optimal
                control and safety.
              </p>
              ...
              <div className="bg-white/20 backdrop-blur-sm rounded-lg p-6">
                <h4 className="text-lg font-semibold mb-2">
                  SPEAK WITH A STEERING SPECIALIST
                </h4>
                <div className="flex items-center space-x-3">
      ...
      {/* Steering Column Types Section */}
      <section className="py-20 bg-white dark:bg-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">
              Steering Column Types We Specialize In
            </h2>
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              From manual to electric and tilt columns, we have the right
              steering solution for your vehicle's control needs
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-900/20 dark:to-orange-800/20 rounded-xl p-6 hover:shadow-lg transition-shadow duration-300">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Traditional, reliable steering solution for classic and standard
                vehicles
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-900/20 dark:to-orange-800/20 rounded-xl p-6 hover:shadow-lg transition-shadow duration-300">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Enhanced steering assistance for easier handling and comfort
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-900/20 dark:to-orange-800/20 rounded-xl p-6 hover:shadow-lg transition-shadow duration-300">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Adjustable steering columns for optimal driver position and
                comfort
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                Ready To Restore Your Steering?
              </h2>
              <p className="text-xl text-orange-100 mb-8">
                Get started with our quick quote form or speak directly with our
                steering specialists to find the perfect column for your
                vehicle.
              </p>
              ...
              <div className="relative bg-white/10 backdrop-blur-sm rounded-2xl p-8 h-72 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-semibold text-white mb-2">
                    Perfect Steering Match
                  </h3>
                  <p className="text-orange-100">
                    Quality steering columns for enhanced control
                  </p>
                </div>
              </div>
            </div>
