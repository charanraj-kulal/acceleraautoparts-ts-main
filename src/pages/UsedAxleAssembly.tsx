  ...
  const benefits = [
    {
      ...
      description: "Used axle assembly costs 65% less than a new one",
    },
    {
      icon: <Cog className="h-6 w-6" />,
      title: "Superior Performance",
      description: "Restore your vehicle's drivetrain with proven reliability",
    },
    {
      icon: <Shield className="h-6 w-6" />,
      title: "Long-lasting Durability",
      description: "Quality axle assemblies built to withstand heavy loads",
    },
    {
      icon: <Users className="h-6 w-6" />,
      title: "OEM Quality",
      description: "Original equipment manufacturer standards maintained",
    },
  ];
  ...
  const features = [
    {
      ...
      description: "Only the finest OEM used axle assemblies",
    },
    {
    ...
    },
    {
      ...
      title: "Twice Tested",
      description: "Rigorous testing for structural integrity",
    },
    {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
                Premium Used
                <span className="block text-orange-100">Axle Assemblies</span>
              </h1>
              <p className="text-xl text-orange-100 mb-8 max-w-2xl">
                Power your vehicle's performance with our premium quality used
                axle assemblies. Tested, verified, and ready to handle the
                toughest roads nationwide.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-900/20 dark:to-orange-800/20 rounded-2xl p-0 h-96 flex items-center justify-center overflow-hidden">
                <img
                  src="/assets/images/car_parts/axle.png"
            ...
            <div className="space-y-6">
              <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
                Axle assemblies are critical components that connect your
                vehicle's differential to the wheels, transmitting power from
                the engine to provide motion. Our high-quality used axle
                assemblies offer exceptional value while ensuring reliable power
                transmission and handling.
              </p>

              <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
                At Accelera Auto Parts, we thoroughly inspect and test all our
                axle assemblies to ensure they meet strict quality standards and
                provide dependable performance for thousands of miles.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-lg">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                ...
                Accelera Auto Parts specialize in sourcing premium used axle
                assemblies and guaranteeing their performance. Unlike inflated
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-700 dark:text-gray-300">
                    Quality A-Grade OEM Used Axle Assemblies
                  </span>
                </div>
                <div className="flex items-center space-x-3">
                  <CheckCircle className="h-5 w-5 text-green-500" />
                ...
                <div className="flex items-center space-x-3">
                  <CheckCircle className="h-5 w-5 text-green-500" />
                  <span className="text-gray-700 dark:text-gray-300">
                    Twice Tested Used Axle Assemblies
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl p-8 text-white">
              ...
              <p className="text-orange-100 mb-6 leading-relaxed">
                ...
                help you find the perfect axle assembly for your vehicle.
              </p>
              ...
              <div className="relative bg-white/10 backdrop-blur-sm rounded-2xl p-8 h-72 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-orange-100">
                    Quality axle assemblies delivered nationwide
                  </p>
                </div>
              </div>
            </div>
...
export default UsedAxleAssembly;
