  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900 min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-24">
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="bg-gradient-to-r from-orange-50 to-orange-100 dark:from-orange-900/20 dark:to-orange-800/20 border-l-4 border-orange-500 p-6 rounded-lg">
              <p className="text-orange-800 dark:text-orange-300 italic text-lg mb-3">
        ...
        <div className="mb-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {values.map((value, index) => (
              <div
                key={index}
                className={`${value.color} rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1`}
              >
                <div className="flex items-center mb-6">
                  <div
                    className={`w-16 h-16 ${value.iconColor} bg-white dark:bg-gray-800 rounded-full flex items-center justify-center mr-6 shadow-md`}
                  >
                    {value.icon}
                  </div>
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white">
                ...
                <div className="flex flex-wrap gap-2">
                  {value.features.map((feature, idx) => (
                    <span
                      key={idx}
                      className="bg-white dark:bg-gray-800 px-3 py-1 rounded-full text-sm font-medium text-gray-700 dark:text-gray-300 shadow-sm"
                    >
                      {feature}
                    </span>
                  ))}
        ...
        <div className="bg-gradient-to-r from-orange-50 to-orange-100 dark:from-orange-900/20 dark:to-orange-800/20 rounded-2xl p-12 mb-24">
            ...
            {features.map((feature, index) => (
              ...
              >
                <div className="flex items-start">
                  ...
                  <div>
                    <span className="inline-block bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 px-2 py-1 rounded text-xs font-medium mb-2">
                      {feature.category}
                    </span>
        ...
        <div className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 rounded-2xl p-12 text-center relative overflow-hidden">
